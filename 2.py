...
# Copyright (C) 2015  Semenovsky, Oleg <o.semenovsky@gmail.com>
...
class Skype():
    ...
    def authenticate(self):
        ...
        auth_response = self.session.post("http://login.live.com",
                                          params=post_payload,
                                          data=self.creds,
                                          headers=auth_headers)

        print(auth_response.content.decode("utf-8"))
...
print(sk.initial.content.decode("utf-8"))
#sk.authenticate()
#print(sk.is_authenticated())